...
def main():
    ...
    # calculate GFLOPs-T and Params-T
    # model_t = eval('lib.models.'+cfg.MODEL.NAME+'.get_pure_trans')(
    #     cfg, is_train=True
    # )
    # # dump_input_t = torch.rand(
    # #     (1, int(cfg.MODEL.IMAGE_SIZE[0]/4), int(cfg.MODEL.IMAGE_SIZE[1]/4), int(cfg.MODEL.IMAGE_SIZE[0]/4))
    # # )
    # dump_input_t = torch.rand(
    #     (1, 32, 64, 48)
    # )
    # logger.info(get_model_summary(model_t, dump_input_t))
